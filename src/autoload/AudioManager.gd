...
func play_rand_sfx() -> void:
	...
	match rand_sound:
		0: 
			get_node("SFX_01").set_volume_db(lin_to_db(AudioManager.get_sfx_vol()))
			get_node("SFX_01").play()
		1: 
			get_node("SFX_02").set_volume_db(lin_to_db(AudioManager.get_sfx_vol()))
			get_node("SFX_02").play()
		2: 
			get_node("SFX_03").set_volume_db(lin_to_db(AudioManager.get_sfx_vol()))
			get_node("SFX_03").play()


func play_victory_sound() -> void: 
	if AudioManager.get_sfx_on():
		get_node("VictorySound").set_volume_db(lin_to_db(AudioManager.get_sfx_vol()))
